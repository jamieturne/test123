...
const scenarios = [
  { query: 'Какой у меня тариф и сколько на счёте?', response: 'У вас подключён тариф <strong>«Быстрые платежи»</strong>. Остаток на рублёвом счёте: <strong>1 247 500 ₽</strong>. Следующее списание за обслуживание — 1 июля.' },
  { query: 'Переведи 50 000 по СБП на +7 900 123-45-67', response: 'Подготовил перевод <strong>50 000 ₽</strong> по СБП на номер <strong>+7 900 123-45-67</strong>. Получатель — Иванов Иван. Подтвердите операцию.' },
  { query: 'Выстави счёт ООО «Рога и Копыта» на 150 000 ₽', response: 'Счёт на <strong>150 000 ₽</strong> для ООО «Рога и Копыта» сформирован. Назначение платежа: «Консалтинговые услуги».' },
  { query: 'Мой счёт заблокирован, что делать?', response: 'Ваш счёт <strong>•••4072</strong> приостановлен по решению ФНС (ст. 76 НК РФ). Для разблокировки:<br/>1. Оплатите задолженность<br/>2. Получите решение об отмене в ФНС<br/>3. Отправьте через раздел «Документы»' },
  { query: 'Покажи профиль компании', response: 'ООО «Технопарк», ИНН <strong>7707123456</strong>, КПП 770701001. Генеральный директор — Петров А. В. Дата регистрации: 12.03.2019. Статус: действующая.' },
];
